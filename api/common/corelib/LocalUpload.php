...
class LocalUpload
{
    ...
    static public function upload_config($type=null,$size=null,$uploadpath=null){
        if(empty($uploadpath)){
            self::$uploadpath=dirname(dirname(dirname(__FILE__))).DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'web'.\Yii::$app->params['upload']['upload_path'];
        }else{
            self::$uploadpath=dirname(dirname(dirname(__FILE__))).DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'web'.\Yii::$app->params['upload']['upload_path'].$uploadpath.DIRECTORY_SEPARATOR;
        }
