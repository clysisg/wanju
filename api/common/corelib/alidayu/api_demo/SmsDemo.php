<?php
namespace app\common\corelib\alidayu\api_demo;
...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIgVBAVRfbF4NC"; // AccessKeyId

        $accessKeySecret = "1uIUAeFsvKu2xm1Bz7oI0qXmh3NjWC"; // AccessKeySecret
...
$response = SmsDemo::queryDetails(
    "18664699093",  // phoneNumbers 电话号码
    "20171106", // sendDate 发送时间
    10, // pageSize 分页大小
    1 // currentPage 当前页码
